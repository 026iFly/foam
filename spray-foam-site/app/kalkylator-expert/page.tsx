  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-gray-900">Laddar expertkalkylatorn...</div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            >
              ← Tillbaka till enkel kalkylator
            </Link>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-md p-8">
                <h2 className="text-3xl font-semibold mb-2 text-center text-gray-900">Expert Rekommendationer</h2>
